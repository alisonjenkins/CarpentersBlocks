...
public class BlockHandlerCarpentersStairs extends BlockHandlerBase
{
	...
	public boolean renderCarpentersBlock(TECarpentersBlock TE, RenderBlocks renderBlocks, Block srcBlock, int renderPass, int x, int y, int z)
    {
    	...
    	BlockCarpentersStairs blockRef = (BlockCarpentersStairs) CarpentersBlocks.blockCarpentersStairs;
    	
    	for (int box = 0; box < 3; ++box)
    	{
    		float[] bounds = blockRef.genBounds(box, data);
    		...
    		if (bounds != null)
    		{
    			...
    			{    				
    	    			...
    	    			)
    				{
    					...
    					if (clipSideCoverBoundsBasedOnState(renderBlocks, data, box, side))
    					{
