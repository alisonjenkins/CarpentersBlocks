...
public class BlockHandlerCarpentersBarrier extends BlockHandlerBase
{
	...
	{  	
    	if (blockAccess.getBlockId(x, y, z) == CarpentersBlocks.blockCarpentersBarrierID)
    	{
    		TECarpentersBlock TE = (TECarpentersBlock) blockAccess.getBlockTileEntity(x, y, z);
    		
        	BlockCarpentersBarrier blockRef = (BlockCarpentersBarrier) CarpentersBlocks.blockCarpentersBarrier;
	...
	public boolean renderFence(TECarpentersBlock TE, RenderBlocks renderBlocks, Block coverBlock, Block srcBlock, int x, int y, int z)
    {
        ...
        float x_Low = 0, x_High = 0;
        float y_Low = 0, y_High = 0;
        float z_Low = 0, z_High = 0;
    ...
    public boolean renderPicketFence(TECarpentersBlock TE, RenderBlocks renderBlocks, Block coverBlock, Block srcBlock, int x, int y, int z)
    {
		...
		boolean isBarrierAbove = renderBlocks.blockAccess.getBlockId(x, y + 1, z) == CarpentersBlocks.blockCarpentersBarrierID;
		boolean isBarrierBelow = renderBlocks.blockAccess.getBlockId(x, y - 1, z) == CarpentersBlocks.blockCarpentersBarrierID;
