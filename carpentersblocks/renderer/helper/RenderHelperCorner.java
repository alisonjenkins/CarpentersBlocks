...
public class RenderHelperCorner extends VertexHelper {
	
	/**
	 * Renders the given texture to the bottom east/west face of the block. Args: slope, x, y, z, texture
	 */
	public static void renderFaceYNegZNegZPos(RenderBlocks renderBlocks, int slope, double x, double y, double z, Icon icon)
	{
	...
	/**
	 * Renders the given texture to the bottom north/south face of the block. Args: slope, x, y, z, texture
	 */
	public static void renderFaceYNegXNegXPos(RenderBlocks renderBlocks, int slope, double x, double y, double z, Icon icon)
	{
		double uMin = icon.getInterpolatedU(renderBlocks.renderMinX * 16.0D);
		double uMax = icon.getInterpolatedU(renderBlocks.renderMaxX * 16.0D);
		double vMin = icon.getInterpolatedV(renderBlocks.renderMinZ * 16.0D);
	...
	/**
	 * Renders the given texture to the top east/west face of the block. Args: slope, x, y, z, texture
	 */
	public static void renderFaceYPosZNegZPos(RenderBlocks renderBlocks, int slope, double x, double y, double z, Icon icon)
	{
		double uMin = icon.getInterpolatedU(renderBlocks.renderMinX * 16.0D);
		double uMax = icon.getInterpolatedU(renderBlocks.renderMaxX * 16.0D);
		double vMin = icon.getInterpolatedV(renderBlocks.renderMinZ * 16.0D);
	...
	/**
	 * Renders the given texture to the top north/south face of the block. Args: slope, x, y, z, texture
	 */
	public static void renderFaceYPosXNegXPos(RenderBlocks renderBlocks, int slope, double x, double y, double z, Icon icon)
	{
		double uMin = icon.getInterpolatedU(renderBlocks.renderMinX * 16.0D);
		double uMax = icon.getInterpolatedU(renderBlocks.renderMaxX * 16.0D);
		double vMin = icon.getInterpolatedV(renderBlocks.renderMinZ * 16.0D);
