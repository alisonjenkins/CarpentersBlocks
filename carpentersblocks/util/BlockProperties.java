...
public class BlockProperties
{
	 ...
	 */
	public final static void clearAttributes(TECarpentersBlock TE, int side)
	{
		suppressUpdate = true;
	 ...
	 */
	public final static int getCoverID(TECarpentersBlock TE, int side)
	{
	 ...
	 */
	public final static int getCoverMetadata(TECarpentersBlock TE, int side)
	{
	 ...
	 */
	public final static boolean hasCover(TECarpentersBlock TE, int side)
	{
	 ...
	 */
	public final static boolean hasSideCovers(TECarpentersBlock TE)
	{
	 ...
	 * Returns cover block.
	 */
	public final static Block getCoverBlock(IBlockAccess world, int side, int x, int y, int z)
	{
	 ...
	 * Returns cover block.
	 */
	public final static Block getCoverBlock(TECarpentersBlock TE, int side)
	{
		Block coverBlock;
	 ...
	 * Sets cover block.
	 */
	public final static void setCover(TECarpentersBlock TE, int side, ItemStack itemStack)
	{		
		if (hasCover(TE, side))
		...
		/*
		 * Carpenter's Bed uses metadata for directional purposes.
		 * We must not alter it or player sleeping direction won't look right.
		 * Metadata for the base cover is always stored in cover[6] anyways.
		 */
		if (side == 6 && TE.worldObj.getBlockId(TE.xCoord, TE.yCoord, TE.zCoord) != CarpentersBlocks.blockCarpentersBedID)
	 ...
	 * Sets color for side.
	 */
	public static void setDyeColor(TECarpentersBlock TE, int side, int metadata)
	{
		if (TE.color[side] > 0)
	 ...
	 * Sets overlay.
	 */
	public static void setOverlay(TECarpentersBlock TE, int side, ItemStack itemStack)
	{
	 ...
	 * Sets pattern.
	 */
	public static void setPattern(TECarpentersBlock TE, int side, int pattern)
	{
