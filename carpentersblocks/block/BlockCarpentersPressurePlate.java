...
public class BlockCarpentersPressurePlate extends BlockBase
{
    ...
    {
        return world.doesBlockHaveSolidTopSurface(x, y - 1, z) || world.getBlockId(x, y - 1, z) == CarpentersBlocks.blockCarpentersBarrierID;
    }
	...
	protected void auxiliaryOnNeighborBlockChange(TECarpentersBlock TE, World world, int x, int y, int z, int blockID)
    {
        ...
        if (!world.doesBlockHaveSolidTopSurface(x, y - 1, z) && world.getBlockId(x, y - 1, z) != CarpentersBlocks.blockCarpentersBarrierID)
            dropBlock = true;
	...
	{
		return CarpentersBlocks.carpentersPressurePlateRenderID;
	}
