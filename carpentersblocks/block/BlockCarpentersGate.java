...
public class BlockCarpentersGate extends BlockBase
{
	...
	public void auxiliaryOnBlockPlacedBy(TECarpentersBlock TE, World world, int x, int y, int z, EntityLivingBase entityLiving, ItemStack itemStack)
	{
		 ...
		 */
		TECarpentersBlock TE_YN = (world.getBlockId(x, y - 1, z) == this.blockID || world.getBlockId(x, y - 1, z) == CarpentersBlocks.blockCarpentersBarrierID) ? (TECarpentersBlock)world.getBlockTileEntity(x, y - 1, z) : null;
		TECarpentersBlock TE_YP = (world.getBlockId(x, y + 1, z) == this.blockID || world.getBlockId(x, y + 1, z) == CarpentersBlocks.blockCarpentersBarrierID) ? (TECarpentersBlock)world.getBlockTileEntity(x, y + 1, z) : null;
		TECarpentersBlock TE_XN = (world.getBlockId(x - 1, y, z) == this.blockID || world.getBlockId(x - 1, y, z) == CarpentersBlocks.blockCarpentersBarrierID) ? (TECarpentersBlock)world.getBlockTileEntity(x - 1, y, z) : null;
		TECarpentersBlock TE_XP = (world.getBlockId(x + 1, y, z) == this.blockID || world.getBlockId(x + 1, y, z) == CarpentersBlocks.blockCarpentersBarrierID) ? (TECarpentersBlock)world.getBlockTileEntity(x + 1, y, z) : null;
		TECarpentersBlock TE_ZN = (world.getBlockId(x, y, z - 1) == this.blockID || world.getBlockId(x, y, z - 1) == CarpentersBlocks.blockCarpentersBarrierID) ? (TECarpentersBlock)world.getBlockTileEntity(x, y, z - 1) : null;
		TECarpentersBlock TE_ZP = (world.getBlockId(x, y, z + 1) == this.blockID || world.getBlockId(x, y, z + 1) == CarpentersBlocks.blockCarpentersBarrierID) ? (TECarpentersBlock)world.getBlockTileEntity(x, y, z + 1) : null;
	...
	{
		return CarpentersBlocks.carpentersGateRenderID;
	}
